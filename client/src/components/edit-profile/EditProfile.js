...
class EditProfile extends Component {
  ...
  onSubmit(e) {
    ...
    if (typeof this.state.skills === "object") {
      var skills = this.state.skills.join(",");
    } else {
      var skills = this.state.skills;
    }
    // console.log(skills);

    const profileData = { ...this.state, skills };
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info={"City & State (i.e Los Angeles, CA)"}
                />
                ...
                <TextFieldGroup
                  ...
                  error={errors.skills}
                  info={
                    "Please use comma separated values (i.e HTML, CSS, Javascript)"
                  }
                />
